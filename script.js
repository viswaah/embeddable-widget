...
const content = [
    ...
    {
        type: 'p',
        content: 'Depending on whether your business has already been verified by our payment protection partner, Eftsure, you may receive a digital invitation and/or form. This process, powered by Eftsure, helps make verification easier and minimises the legwork of ad hoc documentation requests or paperwork. It also helps protect your company and [company name] from cyber-crime attempts.'
    },
    {
        type: 'h3',
    ...
    {
        type: 'p',
        content: 'If you’re an existing partner to [company name], you might still need to register with Eftsure. This is to protect both of our organisations from risks like external cyber-crime and employee error during the payment process. Once your details are verified by Eftsure, you will not need to be re-verified with any of your other customers who use Eftsure’s solution, although other companies may choose to request additional information or documentation.'
    }
]
